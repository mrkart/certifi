                    ...
                    <div className='col-md-12 text-start'>
                        ...
                        <div className='issuecerttabs'>
                            ...
                            <ul className="nav nav-pills mb-3 justify-content-center" id="ex1" role="tablist">
                                ...
                                <li className="nav-item" role="presentation"><a className="nav-link active" id="ex1-tab-2" data-mdb-toggle="pill" href="#ex1-pills-2" role="tab" aria-controls="ex1-pills-2" aria-selected="false">Attributes</a></li>
                    ...
                    <NavLink to="/attributes" className='btn btn-primary btn-icon icon-rht'>Next < i data-eva-animation="flip" data-eva="arrow-forward-outline"></i></NavLink>
                                ...
                                <div className="tab-pane fade show active fadein" id="ex1-pills-2" role="tabpanel" aria-labelledby="ex1-tab-2">
                                    ...
                                    <div className='row align-items-center'>
                                      <div className='col-6'>
                                      <div className='btngrouprht'>
                                              <NavLink to="/agreement-contract" className='btn btn-light btn-icon'>< i data-eva-animation="flip" data-eva="arrow-back-outline"></i> Back</NavLink></div>
                                    </div>
