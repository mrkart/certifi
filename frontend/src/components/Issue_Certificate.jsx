    ...
    <div className='scrolldiv1'>
      <div className='row '>
        <div className='col-md-12 text-start'>
          ...
          <div>
            <Stepper steps={ [{title: 'Step One'}, {title: 'Step Two'}, {title: 'Step Three'}, {title: 'Step Four'}] } activeStep={ stepper } />
            { stepper === 0 && 
              <div>
                <p>text 1</p>
                <button className='btn btn-light' onClick={() => setStepper(stepper + 1)}>Next</button>
              </div>
            }
            {stepper === 1 && 
              <div>
              <p>text 2</p>
              <button className='btn btn-light' onClick={() => setStepper(stepper - 1)}>Back</button>
              <button className='btn btn-light' onClick={() => setStepper(stepper + 1)}>Next</button>
              </div>
            }
            {stepper === 2 && 
            ...
            {stepper === 3 && 
              ...
              <p>text 4</p>
              <button className='btn btn-light' onClick={() => setStepper(stepper - 1)}>Back</button>
              <button className='btn btn-light'>Finish</button>
              </div>
            }
          </div>
