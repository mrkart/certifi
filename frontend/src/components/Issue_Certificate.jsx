                    ...
                    <div className='createcertform backgroundblur text-start p-15px my-3'>
                      <div className='row'>
                          ...
                          <div className='form-group'>
                            <div className='imgpreviewbox'>
                              ...
                              <p>Background picture</p> */}
                               <img src={require('../assets/images/cert/cert1-split/bg.png')} className="mw-100" loading="lazy" />
                            </div>
                          </div>
                        </div>
                        <div className='col-md-4'>
                          ...
                          <div className='form-group'>
                            <div className='imgpreviewbox'>
                            <img src={require('../assets/images/cert/cert1-split/frame.png')} className="mw-100" loading="lazy" />
                        ...
                        <div className='col-md-4'>
                          ...
                          <div className='form-group'>
                            <div className='imgpreviewbox'>
                            <img src={require('../assets/images/cert/cert1-split/chief-executive-officer.png')} className="mw-100" loading="lazy" />
                        ...
                        <div className='col-md-4'>
                          ...
                          <div className='form-group'>
                            <div className='imgpreviewbox'>
                            <img src={require('../assets/images/cert/cert1-split/department-head.png')} className="mw-100" loading="lazy" />
                        ...
                        <div className='col-md-4'>
                          ...
                          <div className='form-group'>
                            <div className='imgpreviewbox'>
                            <img src={require('../assets/images/cert/cert1-split/president-signature.png')} className="mw-100" loading="lazy" />
