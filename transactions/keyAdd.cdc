transaction(myPublicKey: String, signAlg: Int, hashAlg: Int) {  
  prepare(acc: AuthAccount) {
    ...
    let signAlgorithm = signAlg == 2 ? SignatureAlgorithm.ECDSA_secp256k1 : SignatureAlgorithm.ECDSA_P256
    let hashAlgorithm = hashAlg == 3 ? HashAlgorithm.SHA3_256 : HashAlgorithm.SHA2_256
